...
async function showAll(req, res) {
  try {
    res.send(new Response( Messages.success.code,Messages.success.description,await activityService.activityList()));
...
async function showByCategory(req, res) {
  try {
    res.send(new Response( Messages.success.code,Messages.success.description,await activityService.activityByCategory(req.params.category)));
